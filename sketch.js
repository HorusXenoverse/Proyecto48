...
var pj1Img, pj2Img, ave1Img, ave2Img, bgImg, bg2Img, gameOverImg;
var bgInfinito;
...
function preload(){
  ...
  pj1Img = loadImage("images/pj1.png");
  pj2Img = loadImage("images/pj1.png");
  //Precarga de las imágenes de los obstáculos (Aves en este caso)
  ave1Img = loadImage("images/ave1.png")
  ave2Img = loadImage("images/ave2.png")
  //Precarga de las imágenes de los fondos
  bgImg = loadImage("images/fondo.jpg");
  bg2Img = loadImage("images/fondo2.png");
  //Precarga de las imágenes del game over
  gameOverImg = loadImage("images/gameOver5.png");
}
